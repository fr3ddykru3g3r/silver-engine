...
from iris_report.iris_sep.tools import train_corrected_sepnet_o_v3 as adapter
...
class CorrectedSEPNetOV3Tests(unittest.TestCase):
    ...
    def test_adversarial_validation_features_do_not_change_train_preprocessing(self) -> None:
        ...
        altered = frame.copy(); validation = altered.role != "train"; altered.loc[validation, features] = 999999.0
